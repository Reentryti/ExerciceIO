...
<div class="min-h-screen bg-cover bg-center flex items-center justify-center p-6" >
    ...
    <div class="w-full max-w-4xl bg-white/0 rounded-lg shadow-lg overflow-hidden flex">
      ...
      <div class="w-2/3 p-8">
        ...
        <form @submit.prevent="seConnecter">
          <div class="mb-4">
            ...
            <input v-model="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-600 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" required/>
          </div>
          <div class="mb-6">
      ...
      <div class="w-1/3 bg-blue-500 text-white p-8 flex flex-col items-center justify-center">
        ...
        <router-link to="/inscription" class="bg-white text-blue-500 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
          S'inscrire
        </router-link>
      </div>
    </div>
