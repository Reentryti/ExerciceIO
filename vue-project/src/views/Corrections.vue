<template>
    <div class="container mx-auto p-4">
      ...
      <div v-if="currentView === 'exercices'">
        ...
        <h2 class="text-2xl font-bold mb-4">Exercices pour {{ selectedClasse.nom }}</h2>
        <ul class="space-y-2">
      ...
      <div v-if="currentView === 'solutions'">
        ...
        <h2 class="text-2xl font-bold mb-4">Solutions pour {{ selectedExercice.titre }}</h2>
            ...
            <tbody>
              <tr v-for="solution in solutions" :key="solution.id">
                ...
                <td class="py-2 px-4 border-b">
                  <input v-model="solution.note" type="number" min="0" max="20" step="0.5"
                         @change="updateNote(solution)"
                         class="w-20 p-1 border rounded">
                </td>
                <td class="py-2 px-4 border-b">
                  <a :href="solution.fichier" target="_blank" 
                     class="text-blue-600 hover:underline">Voir fichier</a>
                </td>
              </tr>
            </tbody>
          </table>
